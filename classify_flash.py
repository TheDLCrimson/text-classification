...
def classify(file_path, vectorizer, model):
    ...
    output_dir = "gemini_flash_response/classified"
...
# List of uploaded files in the gemini_flash_response folder
file_paths = [
    "gemini_flash_response/english_ar_respone.csv",
    "gemini_flash_response/english_bn_respone.csv",
    "gemini_flash_response/english_en_respone.csv",
    "gemini_flash_response/english_gd_respone.csv",
    "gemini_flash_response/english_gn_respone.csv",
    "gemini_flash_response/english_he_respone.csv",
    "gemini_flash_response/english_hi_respone.csv",
    "gemini_flash_response/english_hmn_respone.csv",
    "gemini_flash_response/english_it_respone.csv",
    "gemini_flash_response/english_th_respone.csv",
    "gemini_flash_response/english_uk_respone.csv",
    "gemini_flash_response/english_zh-cn_respone.csv",
    "gemini_flash_response/english_zu_respone.csv",
]
...
output_results_file = "classification_flash_results_summary.csv"
